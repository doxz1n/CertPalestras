...
function About() {
  return (
    <Layout>
      <Head>
        <title>
          Sobre Nós - Sistema de Gerenciamento e Emissão de Certificados
        </title>
      </Head>
      <Header />
      <main className="container mx-auto p-4">
        ...
        <p className="mb-8">
          ...
          administração de certificados de forma segura e eficiente, atendendo
          às necessidades dos nossos clientes com qualidade e confiabilidade.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <div className="flex mt-4 space-x-4">
              <a
                href="https://www.linkedin.com/in/henrique-alcici-sanchez-09390427b/"
                target="_blank"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-800 hover:text-black-900"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
